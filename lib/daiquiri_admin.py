...
class DaiquiriAdmin():
    ...
    def fetchUwsResultUrl(self, jobId, format):
        """Get url of result for given jobId and format"""

        response = self.get('/uws/query/' + jobId + 'results/', json=False)
    ...
    def getUwsJobsByNameAndPhase(self, jobname, phase):
